...
// words is a list of words used for generating random strings.
...
func (i ID) Mnemomic() string {
	...
	pos := [...]int{
		((i.Position & mask5) << 5) | int(i.Generation&mask5),
		(((i.Position >> 5) & mask5) << 5) | int((i.Generation>>5)&mask5),
		(((i.Position >> 10) & mask5) << 5) | int((i.Generation>>10)&mask5),
		(((i.Position >> 15) & mask5) << 5) | int((i.Generation>>15)&mask5),
		(((i.Position >> 20) & mask5) << 5) | int((i.Generation>>20)&mask5),
		(((i.Position >> 25) & mask5) << 5) | int((i.Generation>>25)&mask5),
		(((i.Position >> 30) & mask5) << 8) | int((i.Generation>>30)&mask8),
		int((i.Generation >> 38) & mask10),
		int((i.Generation >> 48) & mask10),
		int((i.Generation >> 58) & mask10),
	}

	result := make([]string, 0, 10)
	for _, p := range pos {
		if p != 0 {
			result = append(result, words[p])
		}
	}
